# -*- coding: utf-8 -*-
"""
Created on Thu Jul 30 14:58:05 2020
...
class CS_NCA():
    def __init__(self, low_dims, cost_par, optimizer = 'gd', max_steps = 500, tol = 1e-10, init_style = "normal", init_stddev = 0.1, verbose = True, learning_rate = None):
        '''
        init function
